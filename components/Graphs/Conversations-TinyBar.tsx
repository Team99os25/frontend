    ...
    <div className="w-[400px] h-[250px]">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data}>
          ...
          {/* ✅ Changed: Removed static fill, added dynamic Cell coloring */}
          <Bar dataKey="value">
