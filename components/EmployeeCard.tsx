...
export function EmployeeCard({ employeeId, employeeName, vulnerabilityScore, date }: EmployeeCardProps) {
  return (
    <Link href={`/employee/${employeeId}`}>
      <Card className="w-full bg-slate-800/80 backdrop-blur-sm border border-slate-700 shadow-lg hover:shadow-blue-900/20 transition-all duration-300 cursor-pointer transform hover:scale-[1.02] active:scale-[1.01] mb-3 hover:border-blue-500/30">
