                ...
                sessions: [
                    {
                        ...
                        summary:
                            "Employee expressed concerns about work-life balance. Mentioned increasing workload and difficulty managing deadlines. Shows signs of stress and burnout.",
                        date: "2024-04-07",
                        escalationReasons: [
                            "High stress levels",
...
const Page = ({ params }: { params: Promise<{ employeeId: string }> }) => {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-slate-900 to-blue-900 text-white">
                Loading...
            </div>
        );
    }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p className="text-slate-300">
                                Last Session:{" "}
                                {format(
                                    new Date(employee.lastSessionDate),
                                    "MMM d, yyyy",
                                )}
                            </p>
                        </div>
                        <div className="flex justify-center md:justify-end items-center">
                            <div className="text-center">
                                ...
                                <CircularProgress
                                    value={employee.vulnerabilityScore}
                                />
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <ul className="list-disc list-inside space-y-1">
                                        {selectedSession.escalationReasons.map((
                                            reason,
                                            index,
                                        ) => (
                                            <li
